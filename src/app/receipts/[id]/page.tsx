...
import { ArrowLeft, LayoutDashboard, Printer, Share2, Receipt, Package, CheckCircle2, Wallet, CreditCard } from "lucide-react"
    ...
    async function fetchOrder() {
      ...
      try {
        ...
        if (foundOrder) {
          ...
          try {
            const stores = await clientApi.get<Store[]>(`/api/v1/stores/`)
